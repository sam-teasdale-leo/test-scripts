...
CODE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/authentication/login' \
  -H 'Content-Type: application/json' \
  -d '{
    "application_id": "e7765d84-839f-411a-8884-a8ef628d36d8",
...
RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/authentication/token' \
...
COMMON_RECEIVERS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/common-receivers' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
...
COMMON_RECEIVERS_CALLS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/common-receivers-calls' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
RECEIVER_SEARCH_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/receiver-search' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
SITES_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/sites' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
TENANTS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/tenants' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
RECEIVER_STATES_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus-staging.staging.threatdeterrence.com/api/v1/receiver-states' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
