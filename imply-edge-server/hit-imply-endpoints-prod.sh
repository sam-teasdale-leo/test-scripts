...
CODE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/authentication/login' \
  -H 'Content-Type: application/json' \
  -d '{
    "application_id": "5c59f3bb-9d86-4d05-bfa3-c7ab583ebc6b",
...
RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/authentication/token' \
...
COMMON_RECEIVERS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/common-receivers' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  ...
  -d "{
    \"country_codes\":[\"+1\"],
    \"date_filter\":\"2025-10-01 - 2026-01-31\",
    \"page\":1,
    \"per_page\":5,
    \"receiver_states\":[],
    \"sites\":[],
...
COMMON_RECEIVERS_CALLS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/common-receivers-calls' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
#     \"countryCodes\":[\"+1\"],
#     \"country_codes\":[\"+1\"],
#     \"dateFilter\":\"2025-10-01 - 2026-01-31\",
#     \"date_filter\":\"2025-10-01 - 2026-01-31\",
#     \"_export\":\"csv\",
#     \"export\":\"csv\",
#     \"page\":1,
...
RECEIVER_SEARCH_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/receiver-search' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
SITES_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/sites' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
TENANTS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/tenants' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
RECEIVER_STATES_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/receiver-states' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
AUDITS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/search/audits?page=1&page_size=25' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -H "Authorization: Bearer $TOKEN" \
  -H "X-Forwarded-For: $MY_IP" \
...
# AUDITS_RESPONSE=$(curl -s -X POST 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/search/audits?page=1&page_size=3' \
#   -H 'accept: application/json' \
#   -H 'Content-Type: application/json' \
#   -H "Authorization: Bearer $TOKEN" \
#   -H "X-Forwarded-For: $MY_IP" \
...
# AUTOCOMPLETE_RESPONSE=$(curl -s -X GET 'https://imply-edge-server.verus.threatdeterrence.com/api/v1/autocomplete?source=audit&entity=users&query=Test' \
#   -H 'accept: application/json' \
#   -H 'Content-Type: application/json' \
#   -H "Authorization: Bearer $TOKEN" \
#   -H "X-Forwarded-For: $MY_IP"
